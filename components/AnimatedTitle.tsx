export default function AnimatedTitle() {
  return (
    <>
      <h1 className="hidden select-none space-y-1 text-5xl font-bold leading-none tracking-tight text-zinc-800 dark:text-zinc-100 sm:block">
        <span
      ...
      <h1 className="block select-none space-y-1 text-4xl font-bold leading-none tracking-tight sm:hidden">
        ...
        <span
          ...
          className="relative block before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:block before:w-full before:animate-gradient-background-2 before:text-black before:content-[attr(data-content)]"
        >
          <span className="animate-gradient-foreground-2 bg-gradient-to-r from-gradient-2-start to-gradient-2-end bg-clip-text text-transparent">
            {' '}
        ...
        <span
          data-content="next.js lover."
          className="relative inline-block before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:block before:w-full before:animate-gradient-background-3 before:text-black before:content-[attr(data-content)]"
        >
          <span className="animate-gradient-foreground-3 bg-gradient-to-r from-gradient-3-start to-gradient-3-end bg-clip-text text-transparent">
            {' '}
            next.js lover.
