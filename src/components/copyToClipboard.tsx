...
export default function CopyToClipboard({
  ...
  return (
    <div className={"relative inline-flex items-center"}>
      <button
        type="button"
        className={`inline-flex items-center rounded-xl border border-black py-1.5 px-4 text-[0.8rem] font-medium leading-5 transition md:text-sm md:hover:-skew-x-6 ${
