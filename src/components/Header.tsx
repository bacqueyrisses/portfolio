    ...
    >
      ...
      <span className={`ml-auto mr-10 hidden lg:flex`}>
        ...
        <Link
            ...
            duration={0}
            className={
              "sm:hover:bg-opacity-80 group inline-flex cursor-pointer items-center rounded-md bg-black px-4 py-1.5 font-medium text-secondary transition dark:bg-secondary dark:text-black md:text-base"
            }
        >
          Contact
          <svg
